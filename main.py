...
# Tensor Model Prediction Function
def model_prediction(test_image):
    model = tf.keras.models.load_model('pdd_trained_model.keras')

    # Preprocessing the image in the same format in which model is trained
